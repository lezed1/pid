...
(function() {
    ...
    ////////// FORM //////////
    var kpInput = document.getElementById("kp1");
    var kiInput = document.getElementById("ki1");
    var kdInput = document.getElementById("kd1");
...
(function() {
    ...
    function update() {
        ...
        for (var i = 0; i < history.length; ++i) {
            ctx.fillStyle = "rgba(255,69,191,"+(i/history.length)+")";
            ctx.beginPath();
            ctx.arc(history[i][0], history[i][1], 5, 0, 2 * Math.PI, false);
            ctx.closePath();
            ctx.fill();
    ...
    ////////// FORM //////////
    var kpInput = document.getElementById("kp2");
    var kiInput = document.getElementById("ki2");
    var kdInput = document.getElementById("kd2");
